...
// 우리가 작성한 웹 어플리케이션(war) was(tomcat)dml webapps 폴더 밑에 이동을 시켜주면
// 서버가 기동할때 해당 어플리케이션을 자동으로 로딩
// 웹 어플리케이션의 폴더명이 context path 가 된다 (웹 어플리케이션 이름)
// *** 서버 설정에 의해서 폴더명과 다른 context path를 부여하는게 가능
// (하지만 우리는 서버 엔지니어가 아니기 때문에 해당 부분까지는 가진 않는다.)

// 특정 url을 호출하면, url을 처리해 줄 수 있느 servlet을 호출하여 응답을 생성한다
// servlet 생성방법
// 1. class 를 생성
...
public class HelloServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		//System.out.println("HelloServelet init()");
